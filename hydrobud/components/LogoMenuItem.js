...
const LogoMenuItem = ({label, src, isLink, href, alt, onClickHandler, hover}) => {
    if (isLink){
        return (
            <Menu.Item>
                <ForwardPropsLink href={href}>
                    <div className={`flex flex-row justify-center items-center py-[0.8rem] space-x-[0.5rem] leading-[2.5rem] ${hover ? hover.style:''}`}>
